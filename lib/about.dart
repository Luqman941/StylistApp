...
class _AboutPageState extends State<AboutPage> {
  List<ExpantionModel> exp=[
    ExpantionModel("assets/download (13).jpeg", "Theresa Webb", "Barbers", "5.0"),
    ExpantionModel("assets/download (13).jpeg", "Diane Russel", "Barbers", "5.0"),
    ExpantionModel("assets/download (13).jpeg", "Bessi Cooper", "Barbers", "5.0"),
