...
class FavoriteSaloon extends StatefulWidget {
  const FavoriteSaloon({Key? key}) : super(key: key);

  @override
  State<FavoriteSaloon> createState() => _FavoriteSaloonState();
}

class _FavoriteSaloonState extends State<FavoriteSaloon> {
  @override
